...
func TestEtreeC14NTransformer_Transform(t *testing.T) {
	type args struct {
...
<!-- Comment 3 -->`),
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			transformer := &canonicalXML10Canonicalizer{}
			got, err := transformer.Canonicalize(xades4go.XML{IsOctetStream: false, NodeSet: tt.args.nodeSet})
